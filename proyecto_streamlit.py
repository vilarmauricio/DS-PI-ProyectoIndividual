...
def main():
    ...
    fecha_final_2 = st.sidebar.date_input('Fecha Final Intervalo: ', value= dt.date.fromisoformat('2021-06-15'), min_value= dt.date.fromisoformat(fecha_min), max_value= dt.date.fromisoformat(fecha_max))
